...
[^uni-distro]:
    ...
    is their product. Knowing that both distributions lie on the same interval, we can conclude that
    their joint distribution is also uniform on the area (square) defined by the Cartesian product
