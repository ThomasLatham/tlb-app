...
If you just read through this post and thought to yourself, "Hmm, that seems kind of hand-wavy,"
then I'd have to agree with you. We demonstrated how the estimate works in a way that "makes sense,"
but we only assumed our random randomly-selected point came from a uniform distribution, and the
coin-toss comparison wasn't very rigorous. Below I'll attempt to explain a bit better why this
