---
title: Various Formal Methods for Creating Correct Smart Contracts
datePublished: "2025-03-30"
author: Tom Latham
description: description: An exploration of formal methods for creating correct smart contracts from the perspective of a learner.
...
development process to make sure you don't have any critical issues in your finished product. In
these cases, the field of formal methods is probably pretty baked into the engineering process. For
less critical systems, though, like most software applications, the idea of using math to rigorously
route out any bugs before releasing to production is more of a foreign concept and probably a waste
of resources in most cases — unit testing, integration testing, manual testing and other forms of
software testing usually are sufficient for that purpose.
...
one such element in that intersection is smart contract development. Indeed, as of the time of
