---
title: Various Applications of Formal Methods for Creating Correct Smart Contracts
datePublished: "2025-03-30"
author: Tom Latham
description:
  An exploration of formal methods technologies employed in creating correct smart contracts, from
...
using mathematical tools (i.e., formal methods) to ensure the correct operation of systems. For
systems where it's obviously paramount to "get it right on the first try," such as building a bridge
or spaceship, I think it's perhaps equally obvious that you'll want to employ mathematics in the
...
writing this, there are many companies such as Tezos, Cardano and Ethereum, which are using formal
...
So, without further ado, let's explore some examples of how formal methods are currently being
applied in the space of blockchain development.

# The Coq Proof Assistant and the Tezos blockchain

https://opentezos.com/formal-verification

# Formal Methods at Cardano

https://iohk.io/en/blog/posts/2024/11/26/applying-formal-methods-at-input-output-real-world-examples/

# Formal Methods for Ethereum

https://ethereum.org/en/developers/docs/smart-contracts/formal-verification/#formal-verification-tools
