...
- (c.) that for all such wrapped networks, when they themselves are imbedded in a defined symbolic
...
third variety (c.) ATPs (automated theorem provers, like Reluplex, which allow proving theorems in
an automated way after defining them and which I admittedly understand even less than ITPs) are good
at proving lemmas of the first variety (a.). Neither are good at lemmas of the second variety
however.
